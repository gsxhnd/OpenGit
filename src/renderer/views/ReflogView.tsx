  ...
  return (
    ...
    >
      <div className="flex items-center justify-between px-3 py-2 border-b border-border">
        ...
        <button
          onClick={loadReflog}
          className="px-2 py-0.5 text-xs rounded hover:bg-secondary text-accent"
        >
          Reload
        </button>
      </div>
      ...
      <div className="flex-1 overflow-y-auto font-mono text-xs">
        {reflogEntries.map((entry, i) => (
          <div
            key={i}
            className="flex items-center gap-2 px-3 py-1.5 hover:bg-secondary border-b border-border"
          >
